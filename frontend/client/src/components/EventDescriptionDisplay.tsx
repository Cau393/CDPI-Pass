...
export default function EventDescriptionDisplay({
  ...
  const safe = useMemo(() => sanitizeEventDescriptionHtml(html), [html]);
  ...
  return (
    <div
      className={cn(
        ...
        // TipTap "blank line" is often <p></p>; empty <p> has no height unless forced (matches editor gaps).
        "[&_p:empty]:min-h-[1lh] [&_p:empty]:block",
        "[&_p]:leading-[1.3]",
