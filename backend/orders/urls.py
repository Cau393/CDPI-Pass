...
from .views import (
    ...
    CourtesyLinksDetailView,
    CourtesyLinksView,
    CourtesyMassSendView,
    CourtesyRedeemView,
    OrderView,
    TicketListView,
)
...
urlpatterns = [
    ...
    path(
        "courtesy/redeem/", CourtesyRedeemView.as_view(), name="order-courtesy-redeem"
    ),
    ...
    path(
        "courtesy/links/<str:code>/",
        CourtesyLinksDetailView.as_view(),
        name="courtesy-links-detail",
    ),
    # Courtesy Mass Send courtesy/mass-send/ POST (Admin Only)
    path(
        "courtesy/mass-send/", CourtesyMassSendView.as_view(), name="courtesy-mass-send"
    ),
]
